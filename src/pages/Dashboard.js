...
const Dashboard = () => {
  ...
  // 📖 Filter state for showing
  // all, active or completed tasks
  const [filter, setFilter] = useState('all')

  // 📖 Auth header we send with every request
  // Defined once here so we don't repeat it
  // in every function. DRY principle!
